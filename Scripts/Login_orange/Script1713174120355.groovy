...
WebUI.setEncryptedText(findTestObject('Object Repository/Orange/Page_OrangeHRM/input_Password_password'), 'hUKwJTbofgPskEWN4pMTBw==')
...
WebUI.click(findTestObject('Object Repository/Orange/Page_OrangeHRM/i_System Users_oxd-icon bi-caret-down-fill'))
